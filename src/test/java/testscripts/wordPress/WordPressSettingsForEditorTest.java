...
public class WordPressSettingsForEditorTest {
	...
	//	wd.findElement(By.linkText("Log in")).click();
		// Login to Wordpress
		// Login to wordpress by Editor acccount
		Constants.login(wd, Constants.TestEditor, Constants.TestEditorPassword);
		Thread.sleep(2000);
		WordPressSettingsHelper.openPost(wd, "Test Post For Editor");
		...
		WordPressSettingsHelper.attachMedia(wd,
				"This is test comment 2 for video attachment by Editor",
		...
		WordPressSettingsHelper.attachMedia(wd,
				"This is test comment 3 for audio attachment by Editor",
