...
public class EnableLoadMoreForMediaTest{
	@Test(groups = { "Display" })
	...
	//	wd.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/Display/Loadmore/Functional/pagination btn media Test1.png');");	
		...
		wd.findElement(By.id("rt-form-radio-0")).click();
		
		System.out.println("Clicked on Load More Radio Button");
		wd.findElement(By.id("rtmedia-settings-submit")).click();
		
		System.out.println("rtMedia Settings Saved");
		
		((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/Display/Loadmore/Functional/pagination btn media Test2.png');");	
		...
		Thread.sleep(2000);
		((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/Display/Loadmore/Functional/pagination btn media Test3.png');");	
		...
		if (i==media)
		{
			...
			Thread.sleep(2000);
			((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/Display/Loadmore/Functional/pagination btn media Test4.png');");	
			...
			System.out.println("After clicked Load More,Current Value of Media on the page:"+s);
	...
	((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/Display/Loadmore/Functional/pagination btn media Test5.png');");	
	...
	if (i==media1)
	{
		...
		System.out.println("Clicked Load More Button");
		Thread.sleep(5000);
		((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/Display/Loadmore/Functional/pagination btn media Test6.png');");	
